...
def run(configs: List[Experiment], *filters: Callable[[Experiment], bool]):
    """
...
def main():
    ...
    run(VIDEOMAE_BALANCED_FOCAL, lambda cfg: cfg.dataset == "coralcam")
